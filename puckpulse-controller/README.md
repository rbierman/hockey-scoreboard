...
The controller acts as the central hub for the PuckPulse system:
...
When installed as a package, it runs as a systemd service (`puckpulse-controller.service`).
