...
All notable changes to the PuckPulse Controller will be documented in this file.
...
### Changed
- **Rebranding**: Officially renamed the project from "ScoreMaster" to **PuckPulse**.
- **Project Structure**: Renamed core directories to `puckpulse-controller` and `puckpulse-app`.
- **System Services**: Updated Linux systemd services and packaging to use the `puckpulse` prefix.
